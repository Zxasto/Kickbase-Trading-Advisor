...
league_name = "Auf geht\u0027\uFE0Fs Ab gehts"  # Name of your league, must be exact match, can be done via env or hardcoded
start_budget = 50_000_000               # Starting budget of your league, used to calculate current budgets of other managers
league_start_date = "2025-07-22"        # Start date of your league, used to filter activities, format: YYYY-MM-DD
